...
/**
 * Created by TanvirHossain on 13/10/2016.
 */

public class Connection2 extends SQLiteOpenHelper {
    private static final int DATABASE_VERSION = 1;
    private static final String PASS_KEY = "123";
    ...
    public Connection2(Context context) {
        super(context, DBLocation, null, DATABASE_VERSION);
        dbContext=context;
        ud_context=context;
        SQLiteDatabase database = SQLiteDatabase.openOrCreateDatabase(DBLocation, PASS_KEY, null);
    }

    @Override
    public void onCreate(SQLiteDatabase db) {
        //db = SQLiteDatabase.openOrCreateDatabase(DBLocation, PASS_KEY, null);
    }
    ...
    public boolean TableExists(String TableName)
    {
        ...
        SQLiteDatabase db = this.getReadableDatabase(PASS_KEY);
        try
        {
    ...
    {
        SQLiteDatabase db = this.getWritableDatabase(PASS_KEY);
    ...
    public String ReturnSingleValue(String SQL)
    {
        ...
        try {
            //SQLiteDatabase db = this.getReadableDatabase(PASS_KEY);
            SQLiteDatabase db = SQLiteDatabase.openOrCreateDatabase(DBLocation, PASS_KEY, null);
            Cursor cur = db.rawQuery(SQL, null);
...
/*    public static void MessageBox(Context ClassName,String Msg)
    ...
    public boolean InsertData(String TableName, ContentValues content_value) {
        SQLiteDatabase db = getWritableDatabase(PASS_KEY);
